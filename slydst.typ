...
#let slides(
  ...
  if title != none {
    ...
    title-slide[
      #place(top + left, dx: -1pt, dy: -20pt)[
        #figure(image("/images/logo.png", width: 11%))
    ]
      ...
      #set text(1.1em, weight: "bold")
        ...
        place(bottom, dy: -1.4em, authors.join(", ", last: " and "))
      } else {
        align(left, authors.join(", ", last: " and "))
      }
      #place(bottom)[
      #if institute != none { text(0.9em, weight: "bold", institute) }]
    ]
  }
